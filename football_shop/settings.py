...
SECRET_KEY = 'django-insecure-te)b%b$kbsx#627an#x0+e37)*_nhr1or#2zma2btjm)la-7hb'

# SECURITY WARNING: don't run with debug turned on in production!
PRODUCTION = os.getenv('PRODUCTION', 'False').lower() == 'true'
DEBUG = True

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "muhammad-vegard-footballshop.pbp.cs.ui.ac.id", "10.0.2.2"]
CSRF_TRUSTED_ORIGINS = [
    "https://muhammad-vegard-footballshop.pbp.cs.ui.ac.id"
]
